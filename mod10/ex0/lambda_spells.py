...
# power_filter = lambda mages, min_power: filter(
...
# spell_transformer = lambda spells: map(
# lambda spellname:'* ' + spellname + ' *', spells)
...
def mage_stats(mages: list[dict]) -> dict:
    ...
    result['avg_power'] = round(sum(lmb) / len(mages), 2)
